...
var ReactGridLayout = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ReactGridLayout, [{
    ...
    /*: ?string*/
    {
      ...
      var nbRow = Math.max(this.props.rows || 0, (0, _utils.bottom)(this.state.layout));
    ...
    /*: ?ReactElement<any>[]*/
    {
      ...
      var _this$props6 = this.props,
          ...
          emptyComponent = _this$props6.emptyComponent,
      ...
      var emptyGridItems = (0, _utils.findEmptyCells)(layout, cols, rows);
      var emptyCells = emptyGridItems.map(function (item) {
        return /*#__PURE__*/React.createElement(_GridItem.default, {
          h: 1,
          w: 1,
          x: item.x,
          ...
          useCSSTransforms: useCSSTransforms,
          transformScale: transformScale
        }, emptyComponent ? emptyComponent(item) : /*#__PURE__*/React.createElement("div", null));
      });
      return emptyCells;
    }
    /**
    ...
    /*: ?ReactElement<any>*/
    {
      ...
      var _this$props7 = this.props,
          ...
          isDraggable = _this$props7.isDraggable,
          isResizable = _this$props7.isResizable,
          isBounded = _this$props7.isBounded,
          useCSSTransforms = _this$props7.useCSSTransforms,
          transformScale = _this$props7.transformScale,
          draggableCancel = _this$props7.draggableCancel,
          draggableHandle = _this$props7.draggableHandle,
          resizeHandles = _this$props7.resizeHandles,
          resizeHandle = _this$props7.resizeHandle;
    ...
    /*: React.Element<"div">*/
    {
      ...
      }), isDroppable && this.state.droppingDOMNode && this.processGridItem(this.state.droppingDOMNode, true), this.placeholder(), empties);
    }
  }], [{
